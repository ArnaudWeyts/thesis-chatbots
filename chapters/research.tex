...
\begin{figure}[p]
	\centering
	\includegraphics[width=0.9\textwidth]{chatbot-benefit-graph2}\label{fig:chatbot-benefit-graph2}
	\caption{Industries projected to benefit from chatbots~\cite{chatbot-industry-benefits}}
\end{figure}

\begin{figure}[p]
	\centering
	\includegraphics[width=0.9\textwidth]{chatbot-benefit-graph}\label{fig:chatbot-benefit-graph}
