...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{dialogflow-inline-editor-testing}\label{fig:dialogflow-inline-editor-testing}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.9\textwidth]{dialogflow-prompts}\label{fig:dialogflow-prompts}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.9\textwidth]{dialogflow-intent-events}\label{fig:dialogflow-intent-events}
